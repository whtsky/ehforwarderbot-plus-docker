...
RUN pip3 install --upgrade pip && pip3 install pysocks ehforwarderbot efb-telegram-master \
    ...
    && pip3 install efb-patch-middleware efb-mp-instantview-middleware efb-msg_blocker-middleware efb-online-middleware efb-notice-middleware efb-voice_recog-middleware \
